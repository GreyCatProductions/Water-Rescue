...
public class ScenarioManager 
{
	...
	private static Scenario CreateLakeScenario()
	{
		...
		Vehicle smallAirTanker = new Vehicle ("Small Airtanker", 2, 4, new Step[] {new Step(2, 3, false)}, false, "Searches a small area and marks found survivors", IconManager.smallAirtanker);
		Vehicle localPilot = new Vehicle ("Local Pilot", 1, 6, new Step[] {new Step(2, 1, false), new Step (1, 1, false),new Step(2, 1, false), new Step(1, 1, false), new Step(2, 1, false), new Step(3, 1, false)}, false, "Hobby pilot offers to search. But he will not change his course.", IconManager.smallAirtanker, false, false);
		Vehicle largeAirtanker = new Vehicle ("Large Aitranker", 1, 3, new Step[] {new Step(3, 4, false)}, false, "Searches a big area and marks found survivors", IconManager.bigAirtanker);
		Vehicle Dinghie = new Vehicle ("Dinghie", 5, 1, new Step[] {new Step(1, 1, false)}, true, "Small but fast. Rescues survivors", IconManager.dinghie);
		Vehicle fisherBoat = new Vehicle("Local Fisher", 2, 2, new Step[] {new Step(3, 1, false)}, true, "Some fishers are ready to help us.", IconManager.oiltanker);
	...
	private static Scenario CreateBayScenario()
	{
		...
		Vehicle scoutplane = new Vehicle ("Scoutplane", 3, 6, new Step[] {new Step(2, 3, false)}, false, "Searches a big area and marks found survivors", IconManager.smallAirtanker);
		Vehicle dinghie = new Vehicle ("Dinghie", 2, 1, new Step[] {new Step(1, 1, false)}, true, "Small but fast. Rescues survivors", IconManager.dinghie);
		Vehicle rescueShip = new Vehicle ("Rescue Ship", 3, 3,new Step[] {new Step(3, 3, false)}, true, "Ship specialized on rescue operations. Rescues survivors.", IconManager.rescueShip);
	...
	private static Scenario CreateOceanScenario()
	{
		...
		Vehicle MH65D = new Vehicle ("MH-65D - Helicopter", 5, 6, new Step[] {new Step(2, 7, false)}, true, "Coast Guard helicopter with high tech search equipment.", IconManager.oiltanker);
		Vehicle HC144 = new Vehicle("HC-144A - Airplane", 3, 4, new Step[] {new Step(30, 2, false)}, false, "Coast Guard cargo plane.", IconManager.oiltanker, false, true);
		Vehicle LegendClass = new Vehicle("Legend-class - Ship", 3, 3, new Step[] {new Step(5, 5, false)}, true, "Coast Guard ship with high tech search equipment.", IconManager.oiltanker);
		Vehicle USCGCEagle = new Vehicle("USCGC Eagle - Ship", 2, 5, new Step[] {new Step(7, 7, false)}, true, "Coast Guard Academy ship. Full of cadets, most of them on their first mission", IconManager.oiltanker);
		Vehicle K1200 = new Vehicle("K-Max K-1200 - Helicopter", 3, 8, new Step[] {new Step(3, 3, false)}, true, "Aerial firefighting helicopter.", IconManager.oiltanker);
		Vehicle rescueShip = new Vehicle ("Large Rescue Ship", 3, 3, new Step[] {new Step(5, 2, false)}, true, "Large Ship specialized on rescue operations. Rescues survivors.", IconManager.rescueShip);
